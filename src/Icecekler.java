...
public class Icecekler {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Icecekler window = new Icecekler();
	...
	private void initialize() {
		...
		JLabel lblYemekler = new JLabel("\u0130\u00E7ecekler");
		...
		Image img2 = new ImageIcon(this.getClass().getResource("/fincan.png")).getImage();
		...
		Image img3 = new ImageIcon(this.getClass().getResource("/kola.png")).getImage();
		lblNewLabel_3.setIcon(new ImageIcon(img3));
		
		JButton btnNewButton = new JButton("S\u0131cak \u0130\u00E7ecekler");
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				
				if (frm4 == null){
					frm4 = new SicakIcecekler();
		...
		JButton btnNewButton_1 = new JButton("So\u011Fuk \u0130\u00E7ecekler");
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				
				if (frm5 == null){
					frm5 = new SogukIcecekler();
		...
		Image img4 = new ImageIcon(this.getClass().getResource("/yiyecek.png")).getImage();
		Image img5 = new ImageIcon(this.getClass().getResource("/yiyecek.png")).getImage();

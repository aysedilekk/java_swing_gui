...
public class Salata {
	...
	private void initialize() {
		...
		JLabel lblKahvalt = new JLabel("Salata");
		...
		Image img2 = new ImageIcon(this.getClass().getResource("/akdeniz.png")).getImage();
		lblNewLabel_2.setIcon(new ImageIcon(img2));
		
		JCheckBox chckbxAkdenizSalata = new JCheckBox("Akdeniz Salata");
		chckbxAkdenizSalata.addChangeListener(new ChangeListener() {
			public void stateChanged(ChangeEvent arg0) {
				if(chckbxAkdenizSalata.isSelected()==true){
					System.out.println( chckbxAkdenizSalata.getText());
		...
		panel_3.add(chckbxAkdenizSalata, gbc_chckbxSerpmeKahvalt);
		
		
		
		
		JLabel lblTl = new JLabel("10 TL");
		...
		Image img3= new ImageIcon(this.getClass().getResource("/mevsim.png")).getImage();
		lblNewLabel_3.setIcon(new ImageIcon(img3));
		
		JCheckBox chckbxMevsim = new JCheckBox("Mevsim Salata");
		...
		panel_3.add(chckbxMevsim, gbc_chckbxKyKahvalts);
		
		JLabel lblMevsim = new JLabel("10 TL");
		...
		gbc_lblTl_1.gridx = 2;
		gbc_lblTl_1.gridy = 1;
		panel_3.add(lblMevsim, gbc_lblTl_1);
		...
		Image img4= new ImageIcon(this.getClass().getResource("/tonbalikli.png")).getImage();
		lblNewLabel_4.setIcon(new ImageIcon(img4));
		
		JCheckBox chckbxTonBalýk = new JCheckBox("Ton Bal\u0131kl\u0131 Salata");
		...
		panel_3.add(chckbxTonBalýk, gbc_chckbxSahandaYumurta);
		
		JLabel lblTonBalýk = new JLabel("12 TL");
		...
		gbc_lblTl_2.gridx = 2;
		gbc_lblTl_2.gridy = 2;
		panel_3.add(lblTonBalýk, gbc_lblTl_2);
		...
		Image img5= new ImageIcon(this.getClass().getResource("/tavuklu.png")).getImage();
		lblNewLabel_5.setIcon(new ImageIcon(img5));
		
		JCheckBox chckbxTavuk = new JCheckBox("Tavuklu Salata");
		...
		JLabel lblTavuk = new JLabel("14 TL");
		...
		Image img6= new ImageIcon(this.getClass().getResource("/hellimli.jpg")).getImage();
		lblNewLabel_6.setIcon(new ImageIcon(img6));
		
		JCheckBox chckbxHellim = new JCheckBox("Hellim Peynirli Salata");
		GridBagConstraints gbc_chckbxNewCheckBox = new GridBagConstraints();
		gbc_chckbxNewCheckBox.anchor = GridBagConstraints.WEST;
		gbc_chckbxNewCheckBox.insets = new Insets(0, 0, 5, 5);
		gbc_chckbxNewCheckBox.gridx = 1;
		gbc_chckbxNewCheckBox.gridy = 4;
		panel_3.add(chckbxHellim, gbc_chckbxNewCheckBox);
		
		JLabel lblHellim = new JLabel("13 TL");
		...
		gbc_lblTl_4.gridx = 2;
		gbc_lblTl_4.gridy = 4;
		panel_3.add(lblHellim, gbc_lblTl_4);
		...
		btnSipariiGr.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (chckbxAkdenizSalata.isSelected()){
					...
					Yemek yemek = new Yemek(chckbxAkdenizSalata.getText(), fiyat ,comboBox.getSelectedIndex());
					CafeIn.siparisler.add(yemek);
				}
				
				if (chckbxMevsim.isSelected()){
					int label_text = lblMevsim.getText().trim().indexOf('T');
					String fiyat_text = lblMevsim.getText().substring(0, label_text);
					Double fiyat = Double.parseDouble(fiyat_text);
					Yemek yemek = new Yemek(chckbxMevsim.getText(),fiyat,comboBox_1.getSelectedIndex());
					CafeIn.siparisler.add(yemek);
					
					
				}
				if (chckbxTonBalýk.isSelected()){
					int label_text = lblTonBalýk.getText().trim().indexOf('T');
					String fiyat_text = lblTonBalýk.getText().substring(0, label_text);
					Double fiyat = Double.parseDouble(fiyat_text);
					Yemek yemek = new Yemek(chckbxTonBalýk.getText(),fiyat,comboBox_2.getSelectedIndex());
					CafeIn.siparisler.add(yemek);
				...
				if (chckbxHellim.isSelected()){
					int label_text = lblHellim.getText().trim().indexOf('T');
					String fiyat_text = lblHellim.getText().substring(0, label_text);
					Double fiyat = Double.parseDouble(fiyat_text);
					Yemek yemek = new Yemek(chckbxHellim.getText(),fiyat,comboBox_4.getSelectedIndex());
					CafeIn.siparisler.add(yemek);

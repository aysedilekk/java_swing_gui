...
public class Kahvaltý {
	...
	private void initialize() {
		...
		Image img2 = new ImageIcon(this.getClass().getResource("/serpme.png")).getImage();
		lblNewLabel_2.setIcon(new ImageIcon(img2));
		
		JCheckBox chckbxSerpmeKahvalt = new JCheckBox("Serpme Kahvalt\u0131");
		...
		panel_3.add(chckbxSerpmeKahvalt, gbc_chckbxSerpmeKahvalt);
		
		JLabel lblTl = new JLabel("12 TL");
		...
		Image img3= new ImageIcon(this.getClass().getResource("/koy.png")).getImage();
		lblNewLabel_3.setIcon(new ImageIcon(img3));
		
		JCheckBox chckbxKyKahvalts = new JCheckBox("K\u00F6y Kahvalt\u0131s\u0131");
		...
		panel_3.add(chckbxKyKahvalts, gbc_chckbxKyKahvalts);
		
		JLabel lblTl_1 = new JLabel("16 TL");
		...
		gbc_lblTl_1.gridx = 2;
		gbc_lblTl_1.gridy = 1;
		panel_3.add(lblTl_1, gbc_lblTl_1);
		...
		Image img4= new ImageIcon(this.getClass().getResource("/sahanda.png")).getImage();
		lblNewLabel_4.setIcon(new ImageIcon(img4));
		
		JCheckBox chckbxSahandaYumurta = new JCheckBox("Sahanda Yumurta");
		...
		panel_3.add(chckbxSahandaYumurta, gbc_chckbxSahandaYumurta);
		
		JLabel lblTl_2 = new JLabel("4.50 TL");
		...
		gbc_lblTl_2.gridx = 2;
		gbc_lblTl_2.gridy = 2;
		panel_3.add(lblTl_2, gbc_lblTl_2);
		...
		Image img5= new ImageIcon(this.getClass().getResource("/menemen.png")).getImage();
		lblNewLabel_5.setIcon(new ImageIcon(img5));
		
		JCheckBox chckbxMenemen = new JCheckBox("Menemen");
		...
		panel_3.add(chckbxMenemen, gbc_chckbxMenemen);
		
		JLabel lblTl_3 = new JLabel("6 TL");
		...
		gbc_lblTl_3.gridx = 2;
		gbc_lblTl_3.gridy = 3;
		panel_3.add(lblTl_3, gbc_lblTl_3);
		...
		Image img6= new ImageIcon(this.getClass().getResource("/krep.png")).getImage();
		lblNewLabel_6.setIcon(new ImageIcon(img6));
		
		JCheckBox chckbxKrep = new JCheckBox("Krep");
		GridBagConstraints gbc_chckbxNewCheckBox = new GridBagConstraints();
		gbc_chckbxNewCheckBox.anchor = GridBagConstraints.WEST;
		gbc_chckbxNewCheckBox.insets = new Insets(0, 0, 5, 5);
		gbc_chckbxNewCheckBox.gridx = 1;
		gbc_chckbxNewCheckBox.gridy = 4;
		panel_3.add(chckbxKrep, gbc_chckbxNewCheckBox);
		
		JLabel lblTl_4 = new JLabel("3 TL");
		...
		gbc_lblTl_4.gridx = 2;
		gbc_lblTl_4.gridy = 4;
		panel_3.add(lblTl_4, gbc_lblTl_4);
		...
		Image img7= new ImageIcon(this.getClass().getResource("/yumurtali.png")).getImage();
		lblNewLabel_7.setIcon(new ImageIcon(img7));
		
		JCheckBox chckbxYumurtalEkmek = new JCheckBox("Yumurtal\u0131 Ekmek");
		...
		panel_3.add(chckbxYumurtalEkmek, gbc_chckbxYumurtalEkmek);
		
		JLabel lblTl_5 = new JLabel(" 3.50 TL");
		...
		gbc_lblTl_5.gridx = 2;
		gbc_lblTl_5.gridy = 5;
		panel_3.add(lblTl_5, gbc_lblTl_5);
		...
		btnSipariiGr.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (chckbxSerpmeKahvalt.isSelected()){
					...
					Yemek yemek = new Yemek(chckbxSerpmeKahvalt.getText(), fiyat ,comboBox.getSelectedIndex());
					CafeIn.siparisler.add(yemek);
				}
				
				if (chckbxKyKahvalts.isSelected()){
					int label_text = lblTl_1.getText().trim().indexOf('T');
					String fiyat_text = lblTl_1.getText().substring(0, label_text);
					Double fiyat = Double.parseDouble(fiyat_text);
					Yemek yemek = new Yemek(chckbxKyKahvalts.getText(),fiyat,comboBox_1.getSelectedIndex());
					CafeIn.siparisler.add(yemek);
					
					
				}
				if (chckbxSahandaYumurta.isSelected()){
					int label_text = lblTl_2.getText().trim().indexOf('T');
					String fiyat_text = lblTl_2.getText().substring(0, label_text);
					Double fiyat = Double.parseDouble(fiyat_text);
					Yemek yemek = new Yemek(chckbxSahandaYumurta.getText(),fiyat,comboBox_2.getSelectedIndex());
					CafeIn.siparisler.add(yemek);
					
					
				}
				if (chckbxMenemen.isSelected()){
					int label_text = lblTl_3.getText().trim().indexOf('T');
					String fiyat_text = lblTl_3.getText().substring(0, label_text);
					Double fiyat = Double.parseDouble(fiyat_text);
					Yemek yemek = new Yemek(chckbxMenemen.getText(),fiyat,comboBox_3.getSelectedIndex());
					CafeIn.siparisler.add(yemek);
					
					
				}
				if (chckbxKrep.isSelected()){
					int label_text = lblTl_4.getText().trim().indexOf('T');
					String fiyat_text = lblTl_4.getText().substring(0, label_text);
					Double fiyat = Double.parseDouble(fiyat_text);
					Yemek yemek = new Yemek(chckbxKrep.getText(),fiyat,comboBox_4.getSelectedIndex());
					CafeIn.siparisler.add(yemek);
					
					
				}
				if (chckbxYumurtalEkmek.isSelected()){
					int label_text = lblTl_5.getText().trim().indexOf('T');
					String fiyat_text = lblTl_5.getText().substring(0, label_text);
					Double fiyat = Double.parseDouble(fiyat_text);
					Yemek yemek = new Yemek(chckbxYumurtalEkmek.getText(),fiyat,comboBox_4.getSelectedIndex());
					CafeIn.siparisler.add(yemek);

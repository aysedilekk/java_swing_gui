...
public class Makarna {
	...
	private void initialize() {
		...
		JCheckBox chckbxKýyma = new JCheckBox("K\u0131ymal\u0131");
		...
		panel_3.add(chckbxKýyma, gbc_chckbxKyKahvalts);
		
		JLabel lblKýyma = new JLabel("16 TL");
		...
		gbc_lblTl_1.gridx = 2;
		gbc_lblTl_1.gridy = 1;
		panel_3.add(lblKýyma, gbc_lblTl_1);
		...
		JCheckBox chckbxKremalý = new JCheckBox("Kremal\u0131 Mantarl\u0131");
		...
		panel_3.add(chckbxKremalý, gbc_chckbxMenemen);
		
		JLabel lblKremalý = new JLabel("14 TL");
		...
		gbc_lblTl_3.gridx = 2;
		gbc_lblTl_3.gridy = 3;
		panel_3.add(lblKremalý, gbc_lblTl_3);
		...
		btnSipariiGr.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (chckbxKýyma.isSelected()){
					int label_text = lblKýyma.getText().trim().indexOf('T');
					String fiyat_text = lblKýyma.getText().substring(0, label_text);
					Double fiyat = Double.parseDouble(fiyat_text);
					Yemek yemek = new Yemek(chckbxKýyma.getText(),fiyat,comboBox_1.getSelectedIndex());
					CafeIn.siparisler.add(yemek);
				...
				if (chckbxKremalý.isSelected()){
					int label_text = lblKremalý.getText().trim().indexOf('T');
					String fiyat_text = lblKremalý.getText().substring(0, label_text);
					Double fiyat = Double.parseDouble(fiyat_text);
					Yemek yemek = new Yemek(chckbxKremalý.getText(),fiyat,comboBox_3.getSelectedIndex());
					CafeIn.siparisler.add(yemek);

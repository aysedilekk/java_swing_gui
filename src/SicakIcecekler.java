...
public class SicakIcecekler {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SicakIcecekler window = new SicakIcecekler();
	...
	private void initialize() {
		...
		JLabel lblYemekler = new JLabel("S\u0131cak \u0130\u00E7ecekler");
		...
		Image img3 = new ImageIcon(this.getClass().getResource("/turk.jpg")).getImage();
		...
		JButton btnNewButton_1 = new JButton("Kahveler");
		...
		JButton btnNewButton = new JButton("\u00C7aylar");
